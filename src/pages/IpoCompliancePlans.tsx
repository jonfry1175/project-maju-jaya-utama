...
const IpoCompliancePlans = () => {
  const { t } = useTranslation("ipo-compliance-plans");
  const navigate = useNavigate();

  const handleLearnMoreClick = () => {
    // Redirect to mapping page to create a complete cycle
  ...
  const stats = [
    ...
    { icon: CheckCircle, value: t("stats.items.2.value"), label: t("stats.items.2.label") },
    { icon: Users, value: t("stats.items.3.value"), label: t("stats.items.3.label") },
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="section-padding relative animate-section">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=800&h=600&fit=crop)',
          }}
        >
        ...
        <div className="container mx-auto container-padding relative z-10">
          <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 lg:mb-16">
            <div className="inline-flex items-center bg-white text-primary px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-semibold mb-4 sm:mb-6 border border-primary/20">
              <Scale className="w-3 sm:w-4 h-3 sm:h-4 mr-2" />
              {t("hero.badge")}
            </div>
      ...
      {/* Key Compliance Components Section */}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex items-center bg-white text-primary px-3 sm:px-4 py-2 rounded-full text-body-small font-semibold mb-4 sm:mb-6 border border-primary/20">
                <ClipboardCheck className="icon-small mr-2" />
                {t("process.badge")}
              </div>
...
export default IpoCompliancePlans;