...
const BridgingFinancing = () => {
  ...
  const handleLearnMoreClick = () => {
    navigate("/ipo-process/compliance-plans");
  };
  ...
  const mainObjectives = [
    ...
    {
      icon: DollarSign,
      title: t("objectives.items.3.title"),
      description: t("objectives.items.3.description")
    }
  ];
  ...
  const characteristics = [
    {
      icon: Clock,
      title: t("characteristics.items.0.title"),
      description: t("characteristics.items.0.description")
    },
    {
      icon: Building,
      title: t("characteristics.items.1.title"),
      description: t("characteristics.items.1.description")
    },
    {
      icon: CreditCard,
      title: t("characteristics.items.2.title"),
      description: t("characteristics.items.2.description")
    },
    {
      icon: Banknote,
      title: t("characteristics.items.3.title"),
      description: t("characteristics.items.3.description")
    }
  ];

  const fundUsage = [
    {
      need: t("fundUsage.items.0.need"),
      description: t("fundUsage.items.0.description"),
      icon: FileText
    },
    {
      need: t("fundUsage.items.1.need"),
      description: t("fundUsage.items.1.description"),
      icon: Search
    },
    {
      need: t("fundUsage.items.2.need"),
      description: t("fundUsage.items.2.description"),
      icon: TrendingUp
    },
    {
      need: t("fundUsage.items.3.need"),
      description: t("fundUsage.items.3.description"),
      icon: Eye
    },
    {
      need: t("fundUsage.items.4.need"),
      description: t("fundUsage.items.4.description"),
      icon: TrendingDown
    }
  ];
  ...
  const riskManagement = [
    {
      icon: AlertTriangle,
      title: t("riskManagement.items.0.title"),
      description: t("riskManagement.items.0.description")
    },
    {
      icon: Shield,
      title: t("riskManagement.items.1.title"),
      description: t("riskManagement.items.1.description")
    },
    {
      icon: Users,
      title: t("riskManagement.items.2.title"),
      description: t("riskManagement.items.2.description")
    }
  ];
  ...
  const stats = [
    ...
    { icon: DollarSign, value: t("stats.items.2.value"), label: t("stats.items.2.label") },
      ...
      <section className="section-padding animate-section">
        <div className="container mx-auto container-padding">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 lg:mb-16">
              <div className="inline-flex items-center bg-white text-primary px-3 sm:px-4 py-2 rounded-full text-body-small font-semibold mb-4 sm:mb-6 border border-primary-subtle">
                <Wallet className="icon-small mr-2" />
                {t("fundUsage.badge")}
              </div>
                  ...
                  <Card key={index} className="bg-white border border-subtle hover:shadow-lg transition-all duration-300 card-padding animate-card">
                    <div className="flex items-start space-x-4">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-red-100 rounded-xl flex items-center justify-center flex-shrink-0">
                        <Icon className="icon-small sm:icon-medium text-red-600" />
                      </div>
                      <div className="flex-1">
                        <h3 className="heading-5 text-foreground mb-2">
                          {risk.title}
...
export default BridgingFinancing;