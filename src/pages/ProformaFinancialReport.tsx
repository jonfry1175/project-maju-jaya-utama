...
const ProformaFinancialReport = () => {
  ...
  const assumptions = [
    {
      icon: DollarSign,
      title: t("assumptions.items.0.title"),
      description: t("assumptions.items.0.description")
    },
    {
      icon: Settings,
      title: t("assumptions.items.1.title"),
      description: t("assumptions.items.1.description")
    },
    {
      icon: TrendingUp,
      title: t("assumptions.items.2.title"),
      description: t("assumptions.items.2.description")
    },
    {
      icon: Building,
      title: t("assumptions.items.3.title"),
      description: t("assumptions.items.3.description")
    },
    {
      icon: Calculator,
      title: t("assumptions.items.4.title"),
      description: t("assumptions.items.4.description")
    }
  ];
        ...
        <div className="container mx-auto container-padding">
          <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 lg:mb-16">
            <div className="inline-flex items-center bg-white text-primary px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-semibold mb-4 sm:mb-6 border border-primary/20">
              <BarChart3 className="w-3 sm:w-4 h-3 sm:h-4 mr-2" />
              {t("hero.badge")}
            </div>
...
export default ProformaFinancialReport;