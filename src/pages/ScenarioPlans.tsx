...
const ScenarioPlans = () => {
  ...
  const scenarioPlanningGoals = [
    ...
    {
      icon: Settings,
      title: t("goals.items.3.title"),
      description: t("goals.items.3.description")
    }
  ];

  const externalFactors = [
    {
      category: t("externalFactors.macroeconomic.title"),
      description: t("externalFactors.macroeconomic.description"),
      icon: TrendingUp
    },
    {
      category: t("externalFactors.capitalMarket.title"),
      description: t("externalFactors.capitalMarket.description"),
      icon: BarChart3
    },
    {
      category: t("externalFactors.regulation.title"),
      description: t("externalFactors.regulation.description"),
      icon: FileText
    },
    {
      category: t("externalFactors.competition.title"),
      description: t("externalFactors.competition.description"),
      icon: Users
    },
    {
      category: t("externalFactors.geopolitical.title"),
      description: t("externalFactors.geopolitical.description"),
      icon: AlertTriangle
    }
  ];
  ...
  const scenarioTypes = [
    {
      type: t("scenarioTypes.optimistic.title"),
      characteristics: t("scenarioTypes.optimistic.characteristics"),
      example: t("scenarioTypes.optimistic.example"),
      color: "text-green-600"
    },
    {
      type: t("scenarioTypes.moderate.title"),
      characteristics: t("scenarioTypes.moderate.characteristics"),
      example: t("scenarioTypes.moderate.example"),
      color: "text-blue-600"
    },
    {
      type: t("scenarioTypes.pessimistic.title"),
      characteristics: t("scenarioTypes.pessimistic.characteristics"),
      example: t("scenarioTypes.pessimistic.example"),
      color: "text-red-600"
    }
  ];
  ...
  const actionPlanning = [
    {
      icon: Clock,
      title: t("actionPlanning.items.0.title"),
      description: t("actionPlanning.items.0.description")
    },
    {
      icon: DollarSign,
      title: t("actionPlanning.items.1.title"),
      description: t("actionPlanning.items.1.description")
    },
    {
      icon: Brain,
      title: t("actionPlanning.items.2.title"),
      description: t("actionPlanning.items.2.description")
    },
    {
      icon: Shield,
      title: t("actionPlanning.items.3.title"),
      description: t("actionPlanning.items.3.description")
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Scenario Planning Goals Section */}
        ...
        <div className="container mx-auto container-padding">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              {scenarioPlanningGoals.map((goal, index) => {
      ...
      <section className="section-padding animate-section">
        <div className="container mx-auto container-padding">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 lg:mb-16">
              <div className="inline-flex items-center bg-white text-primary px-3 sm:px-4 py-2 rounded-full text-body-small font-semibold mb-4 sm:mb-6 border border-primary-subtle">
                <PieChart className="icon-small mr-2" />
                {t("scenarioTypes.badge")}
              </div>
              
              <h2 className="heading-2 text-primary mb-4 sm:mb-6">
                {t("scenarioTypes.title")}
              </h2>
              
              <p className="text-body-large text-muted-foreground max-w-3xl mx-auto">
                {t("scenarioTypes.description")}
              </p>
            </div>
              ...
              <table className="w-full bg-white rounded-xl border border-subtle shadow-sm">
                <thead>
                  <tr className="border-b border-subtle bg-muted/50">
                    <th className="text-left p-4 font-semibold text-foreground">{t("scenarioTypes.table.scenario")}</th>
                    <th className="text-left p-4 font-semibold text-foreground">{t("scenarioTypes.table.characteristics")}</th>
                    <th className="text-left p-4 font-semibold text-foreground">{t("scenarioTypes.table.example")}</th>
                  </tr>
                </thead>
                <tbody>
                  {scenarioTypes.map((scenario, index) => (
                    <tr key={index} className="border-b border-subtle hover:bg-muted/20 transition-colors">
                      <td className={`p-4 font-semibold ${scenario.color}`}>
                        {scenario.type}
                      </td>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 lg:mb-16">
              <div className="inline-flex items-center bg-white text-primary px-3 sm:px-4 py-2 rounded-full text-body-small font-semibold mb-4 sm:mb-6 border border-primary-subtle">
                ...
                {t("actionPlanning.badge")}
              </div>
              
              <h2 className="heading-2 text-primary mb-4 sm:mb-6">
                {t("actionPlanning.title")}
              </h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
              {actionPlanning.map((action, index) => {
